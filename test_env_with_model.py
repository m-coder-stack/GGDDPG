...
size = 10000
relay_config = RelayConfig(num=20, speed=10.0, limit_position=False, limit_height=True, max_height=500.0, min_height=100.0)
client_config = ClientConfig(num=100, speed=5.0, traffic=10.0, is_move=False, link_establish=10.0)
